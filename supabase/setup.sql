...
-- Migrations 0001–0053 concatenated in order. Run once on a fresh project.
-- =============================================================================
...
-- >>> 0042_supplier_shipped_to_office.sql <<<
...
-- >>> 0045_tracking_search_by_phone.sql <<<
