...
Province: Pampanga`, [...TIN_FIELDS, ...DELIVERY_FIELDS], opts);
  ...
  check("the applicant's street", tin.values.house_street, "123 Rizal St., Purok 2");
  check("the applicant's barangay", tin.values.address_barangay, "San Roque");
  check("the applicant's city", tin.values.address_city, "Angeles City");
...
Province: Sorsogon`, [...PH_FIELDS, ...DELIVERY_FIELDS], opts);
  ...
  check("the applicant's barangay", ph.values.address_barangay, "Bariis");
  check("the applicant's municipality", ph.values.address_city, "Matnog");
  check("the applicant's province", ph.values.address_province, "Sorsogon");
